...
distinct publisher, so all five seeded sources are independent of one
...
independently-owned newswires. ``endpoint_config`` is structurally-realistic
placeholder metadata only - no fetching is implemented or tested this task
(out of scope).
"""
...
SEED_SOURCES: tuple[Source, ...] = (
    ...
    Source(
        ...
        endpoint_config={"feed_url": "https://www.bloomberg.com/markets/feed"},
    ),
)
