...
| S002-T008 | Extraction service writing Event + `LLMRun` in one transaction, driven by the fake client | T002, T006, T007 | Done |
| S002-T009 | The cycle's extract stage: work queue, per-cycle cap, per-document isolation, status advance | T008 | Done |
| S002-T010 | Monthly budget guard enforcing the ADR-0015 ceiling from recorded token usage | T009 | Done |
