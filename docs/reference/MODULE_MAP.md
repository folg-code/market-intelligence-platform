...
Last updated: 2026-08-18. Sprint 001 tasks S001-T002..T008 are merged; the
...
src/moj_projekt/
  ...
  persistence/   models.py, document_repository.py, source_repository.py,
                 ...
                 the /health db+pgvector check (implemented for Source/
                 Document/Event/EvidencePack/Narrative/NarrativeEpisode/
                 NarrativeEvent/NarrativeRelation)
